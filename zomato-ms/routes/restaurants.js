...
//var restaurantDetailsController=require('../controller/restaurantdetails');
//router.get('/:pageNo', { getRestaurants }.filterRestaurants);
//router.get('/details/:name/:pageNo',restaurantDetailsController.filterRestaurants);
